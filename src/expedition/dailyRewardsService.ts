...
const DAILY_REWARDS: DailyReward[] = [
  ...
  { day: 3, type: 'xp', amount: 50, label: '50 XP' },
  ...
  { day: 7, type: 'boost', amount: 1, itemId: 'xp_boost_1h', label: 'XP x2 🌟' },
  { day: 8, type: 'karbovanets', amount: 300, label: '300 💰' },
  { day: 9, type: 'xp', amount: 100, label: '100 XP' },
  ...
  { day: 13, type: 'xp', amount: 150, label: '150 XP' },
  ...
  { day: 17, type: 'xp', amount: 200, label: '200 XP' },
  ...
  { day: 23, type: 'xp', amount: 300, label: '300 XP' },
  ...
  { day: 27, type: 'xp', amount: 400, label: '400 XP' },
